    ...
    <div className="grid gap-6 xl:grid-cols-[0.72fr_1.28fr]">
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xs">
        ...
        <div className="mt-5 grid gap-3">
          {[
            ...
            <div key={label} className="flex items-center justify-between gap-4 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3">
        ...
        <div className="mt-5 rounded-xl border border-teal-200 bg-teal-50 p-4 text-xs leading-5 text-teal-800">
          <strong>CareerSense Official ID.</strong> The CareerSense {cardRole} ID design is locked to keep every issued card visually consistent.
        </div>
      </section>
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xs sm:p-6">
        ...
        <div className="mt-5 flex min-h-[620px] items-center justify-center rounded-2xl bg-slate-50 p-4 sm:p-8">
          <div
            ref={cardRef}
            style={{ backgroundColor: cardBgColor, boxShadow: `0 28px 60px ${cardShadowColor}` }}
            className="relative h-[560px] w-[350px] overflow-hidden rounded-[28px]"
          >
            {face === "front" ? (
              <>
                <div className="relative h-[225px] bg-[#f9fbfd] p-7">
                  <CardLogo />
                  <div className="absolute -bottom-12 left-1/2 h-36 w-[440px] -translate-x-1/2 rounded-[50%] bg-gradient-to-r from-teal-400 via-cyan-400 to-blue-600" />
                  <div
                    style={{ backgroundColor: cardBgColor }}
                    className="absolute -bottom-8 left-1/2 h-32 w-[430px] -translate-x-1/2 rounded-[50%]"
                  />
                  <div className="absolute -bottom-20 left-1/2 h-40 w-40 -translate-x-1/2 overflow-hidden rounded-2xl border-2 border-blue-500 bg-slate-200 shadow-xl">
                    {avatar ? (
                      <img src={avatar} alt={name} className="h-full w-full object-cover" crossOrigin="anonymous" />
                    ) : (
                ...
                {isPartner ? (
                  <div className="px-7 pb-6 pt-24">
                    <h4 className="text-center text-2xl font-black uppercase tracking-tight text-white">{name}</h4>
                    <p className="mt-1 text-center text-sm font-bold text-teal-300">{status}</p>
                  ...
                  <div className="px-7 pb-4 pt-24">
                    <h4 className="text-center text-2xl font-black uppercase leading-snug tracking-tight text-white line-clamp-2">
                      {name}
                    </h4>
                    <p className="mt-0.5 text-center text-xs font-bold text-teal-300 truncate">{status}</p>
              ...
              <>
                <div className="relative z-10 px-8 pt-8">
                  ...
                  <div className="mt-12 text-center">
                    <h4 className="text-[34px] font-black uppercase leading-none tracking-tight text-white">
                      {cardRole} ID Card
                    </h4>
                    <div className="mt-5 flex items-center justify-center gap-3">
                      <span className="h-px w-10 bg-teal-300" />
                      <span className="rounded-lg bg-gradient-to-r from-teal-400 to-cyan-300 px-5 py-2 text-sm font-black uppercase tracking-wider text-[#06284c]">
                        Verified &amp; Active
                      </span>
                      <span className="h-px w-10 bg-teal-300" />
                    </div>
                ...
                <div className="absolute bottom-0 left-1/2 h-[350px] w-[445px] -translate-x-1/2 rounded-t-[50%] bg-[#f9fbfd] px-[62px] pb-4 pt-[68px]">
                  <p className="text-center text-[11px] font-bold leading-[18px] text-[#07172f]">
                    {isPartner
                  ...
                  <div className="grid gap-2 text-left text-[10.5px] font-semibold text-slate-700">
                    <span className="flex items-center gap-3 border-b border-dashed border-teal-300 pb-1.5">
                      <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-blue-700 text-white"><Mail size={13} /></span>
                      <span className="truncate">{email}</span>
                    </span>
                    <span className="flex items-center gap-3 border-b border-dashed border-teal-300 pb-1.5">
                      <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-blue-700 text-white"><Globe size={13} /></span>
                      careersenseai.com
                    </span>
                    <span className="flex items-center gap-3 border-b border-dashed border-teal-300 pb-1.5">
                      <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-blue-700 text-white"><Phone size={13} /></span>
                      {phone}
                    </span>
                    <span className="flex items-center gap-3">
                      <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-blue-700 text-white"><MapPin size={13} /></span>
                      <span className="truncate">{location}</span>
                    </span>
                  </div>
                  <p className="mt-3 text-center text-[7.5px] font-bold uppercase tracking-[0.12em] text-slate-500">
