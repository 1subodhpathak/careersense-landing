const getApiBase = () => {
  const envUrl = import.meta.env.VITE_API_URL || import.meta.env.VITE_API_BASE_URL || "https://server.datasenseai.com";
  try {
...
export const checkDownloadPass = async (clerkId, resourceType = "document_pdf", resourceId = "default") => {
...
export const createPassOrder = async (clerkId, resourceType = "document_pdf", resourceId = "default") => {
  try {
